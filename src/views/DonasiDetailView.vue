<template>
          ...
          <div class="donation-detail-body">
            ...
            <div class="donation-progress">
              <div class="progress-text">
                 <span>Terkumpul <strong>{{ campaign.terkumpulFormatted }}</strong> dari <strong>{{ campaign.targetFormatted }}</strong></span>
              </div>
            ...
            <RouterLink :to="'/pembayaran/' + campaign.id" class="btn-donate">
              Berdonasi
            </RouterLink>
          </div>
        </div>
  ...
  const donationDatabase = ref({
    "pakan-kucing": {
        ...
        donors: [
            ...
            { name: "Anonim", avatar: "https://i.imgur.com/J16tCfD.png", time: "15 menit yang lalu", amount: 50000 },
            { name: "Budi", avatar: "https://i.imgur.com/k2gW25y.jpg", time: "20 menit yang lalu", amount: 50000 },
        ]
    },
    "rawat-kucing": {
        id: 'rawat-kucing',
  ...
  <style scoped>
    /* Biarkan kosong, CSS sudah ada di main.css */
  </style>