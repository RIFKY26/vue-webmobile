<template>
      ...
      <div v-else class="adoption-container">
        <div class="cat-detail-card">
          ...
          <div class="shelter-info">
            <img :src="currentCat.shelter.avatar" alt="Avatar Shelter">
            <b>{{ currentCat.shelter.name }}</b> - {{ currentCat.shelter.location }}
          </div>
        ...
        <div class="adoption-form-card">
          ...
          <div class="form-content">
            ...
            <div v-if="currentStep === 'adopsi'" class="form-step active">
              ...
              <img src="https://i.imgur.com/gTUKs4H.png" alt="Kucing lucu" class="success-cat-img">
            </div>
          </div>
        </div>
      </div>
  ...
  const catDatabase = ref({
    ...
    "Kiko": {
        name: "Kiko",
        image: "https://i.imgur.com/J16tCfD.png",
        tags: { gender: "Jantan", genderIcon: 'fa-solid fa-mars', breed: "Domestik", health: "Sehat" },
        shelter: { name: "Paw Friends", location: "Yogyakarta", avatar: "https://i.imgur.com/k2gW25y.jpg" },
